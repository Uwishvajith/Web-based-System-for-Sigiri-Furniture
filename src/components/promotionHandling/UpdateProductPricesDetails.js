...
export default function UpdatePromotionDetails() {
  ...
  const onSubmit = async e => {
    ...
    await axios.put(`https://sigiri-furniture-app.herokuapp.comproductprice/updateupdate/${salesid}`, newProductPrices).then(() => {
  ...
  const loadProductPricesDetails = async () => {
    await axios.get(`https://sigiri-furniture-app.herokuapp.comproductprice/getget/${salesid}`).then((res) => {
