...
export default function AllPromotionDetails() {
  ...
  const deletePromotion = async promotionid => {
    ...
    if (answer) {
      ...
      await axios.delete(`https://sigiri-furniture-app.herokuapp.compromotion/delete/${promotionid}`);
  ...
  function searchPromotionByID(e) {
    e.preventDefault();
    axios.get(`https://sigiri-furniture-app.herokuapp.compromotion/searchPromotionByID/${searchproid}`).then((res) => {
      console.log(res.data);
      setPromotions(res.data);
    }).catch((err) => {
      alert(err.message);
