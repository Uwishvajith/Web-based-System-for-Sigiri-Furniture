...
export default function AddOrder() {
    ...
    function sendData(e) {
        ...
        if (answer) {
            ...
            axios.post("https://sigiri-furniture-app.herokuapp.comorder/addOrder", newOrder).then(() => {
                alert("Order successfully placed");
                axios.post("https://sigiri-furniture-app.herokuapp.comorderItem/addOrderItems", newOrderItem).then(() => {
    ...
    function checkCustomerExistance() {
        axios.get(`https://sigiri-furniture-app.herokuapp.comcustomer/searchCustomer/${cNIC}`).then((res) => {
    ...
    useEffect(() => {
            ...
            loadOrder();
                    axios.get("https://sigiri-furniture-app.herokuapp.comproductprice/getproductprice").then((res) => {
    ...
    const loadOrder = async () => {
        await axios.get(`https://sigiri-furniture-app.herokuapp.comorder/getLatestOrder/`).then((res) => {
            console.log(res.data);
