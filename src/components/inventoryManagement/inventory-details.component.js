...
export default class InventoryDetails extends Component {
  ...
  deleteInventory(id) {
    axios
      .delete("http://sigiri-furniture-app.herokuapp.com/inventories/" + id)
                  ...
                  <td>
                   ...
                   <div class="mx-auto mb-0">
                      ...
                      <button className="delete btn m-2 p-1 w-75" style={{background:"#d5d9e0"}}
                          ...
                          onClick={()=>{
                          axios.delete("http://sigiri-furniture-app.herokuapp.com/inventories/"+ inventory._id)
                          .then(()=>{
       
                      });
                          axios.get("http://sigiri-furniture-app.herokuapp.com/inventories/")
                          .then((Response)=>{
